...
function drawCircle() {
    ...
    const currentTheme = currentPitchTimerContainer.closest('.timer-app-container').getAttribute('data-theme') || 'red';
...
function initializeThemeSelector() {
    ...
    themeButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            currentPitchTimerContainer.closest('.timer-app-container').setAttribute('data-theme', theme);
...
// Set initial theme
document.querySelector('.timer-app-container').setAttribute('data-theme', 'red');
